"""The community worksheet for the SPAN Experiments.
    ...
    python tools/gen_spanworksheet.py   # -> docs/design/span-requirements-worksheet.md
...
Reads the same sources as gen_spanreqs.py (.aptest/maps, .aptest/totems.txt) for
...
GENERATED by `tools/gen_spanworksheet.py`. Do not hand-edit - re-run it.
